 ...
 */
class GuildesCharacterData extends foundry.abstract.TypeDataModel {
    ...
    return {
      ...
      attributes: new fields.SchemaField({
        physical: new fields.SchemaField({
          // CORRIGÉ : La valeur minimale est bien 1, comme spécifié dans les règles.
      ...
      arts: new fields.SchemaField({
        guerrier: new fields.SchemaField({
          ...
          // CLARIFICATION : Les champs suivants stockent le CHOIX du joueur.
          // La valeur 'initial' n'est qu'une valeur par défaut à la création de la fiche.
...
Hooks.once("init", () => {
  ...
  // On enregistre notre modèle de données pour les acteurs de type "character".
  game.template.actors.character = GuildesCharacterData;
});